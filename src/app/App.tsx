...
const LESSONS: Lesson[] = [
  { id: 0,  title: "Introduction",                description: "Discover the FitAlign philosophy and how breath-based movement can transform your body. Learn why doing less—with more awareness—often yields the most profound results.", duration: "~20 min" },
  { id: 1,  title: "Breathing Fundamentals",       description: "Learn the mechanics of natural, diaphragmatic breathing and why most of us have forgotten how to breathe correctly after years of modern living.", duration: "~15 min" },
  { id: 2,  title: "The Posture–Breath Connection",description: "Explore the inseparable relationship between how you breathe and how you hold your body—and why correcting one always improves the other.", duration: "~18 min" },
  { id: 3,  title: "Understanding Pandiculation", description: "Discover the body's innate reset mechanism—the same process triggered by a deep yawn or laugh—and how to harness it for lasting muscle relief.", duration: "~12 min" },
  { id: 4,  title: "The Nervous System & Stress",  description: "Understand how the sympathetic stress response creates chronic tension patterns, and how breath-based movement activates the parasympathetic pathway to release them.", duration: "~16 min" },
  { id: 5,  title: "Core Muscle Activation",       description: "Learn to engage your deepest core muscles through the natural expansion of breathing—no crunches required. Real core strength begins from the inside out.", duration: "~20 min" },
  { id: 6,  title: "Spinal Alignment Basics",      description: "Understand the spine's natural curves and how breath supports them. Discover why forcing a 'straight back' is counterproductive to real alignment.", duration: "~14 min" },
  { id: 7,  title: "The Rib Cage & Diaphragm",    description: "A deep dive into the primary structure of breath—the rib cage—and how its mobility determines not just breathing quality but your overall posture and vitality.", duration: "~17 min" },
  { id: 8,  title: "Walking Patterns & Gait",      description: "Explore how breath informs each step you take. Discover the primal walking pattern that can relieve hip, knee, and back pain simply by restoring its natural rhythm.", duration: "~22 min" },
  { id: 9,  title: "Somatic Awareness Exercises",  description: "Develop the kinesthetic intelligence to feel what your body is doing from the inside—the foundation of all lasting change in posture and movement.", duration: "~18 min" },
  { id: 10, title: "Releasing Chronic Tension",    description: "Target the holding patterns that build up over years of sitting, stress, and compensation. Learn gentle techniques to unwind deeply held muscular contractions.", duration: "~25 min" },
  { id: 11, title: "Postural Assessment",          description: "Learn to observe and understand your own postural patterns—the imbalances that create pain and the compensations your body has made to cope with them.", duration: "~15 min" },
  { id: 12, title: "Daily Practice Integration",   description: "Discover how to weave FitAlign principles into everyday moments—sitting, standing, walking, and resting—so that every hour becomes an opportunity to heal.", duration: "~13 min" },
  { id: 13, title: "Advanced Breathing Techniques",description: "Expand your breath practice with deeper, more refined techniques that strengthen respiratory muscles, expand lung capacity, and deepen somatic awareness.", duration: "~20 min" },
  { id: 14, title: "Living the FitAlign Method",   description: "Bring everything together into a sustainable, joyful practice. Understand how aligned posture, natural breath, and somatic awareness become a way of life.", duration: "~18 min" },
];
